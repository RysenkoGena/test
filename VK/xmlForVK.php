...
$products = array(98355,97883,97843,97842,96882,96341,94060,89238,84905,84890,84881,82889,80944,72925,72923,70975,70193,65669,56216,56209,56199,55555,51479,49097,45762,41936,41183,41180,36696,29845,25837,25836,25073,19926,18094,17645,16566,16441,13656,12823,12549,12548,11545,11511,111033,106914,105344,105288,105286,102167,100704,100701);
...
While($obEl = $list->GetNext()){
  ...
  if ( $ob = $res->GetNext() ){
      ...
      $description = mb_substr($obEl["DETAIL_TEXT"], 0, 250);
